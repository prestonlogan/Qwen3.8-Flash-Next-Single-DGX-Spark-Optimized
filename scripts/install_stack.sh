...
if [[ "${Q38_S6:-0}" == 1 && "${Q38_HX:-1}" == 1 ]]; then echo "on fx" > $O/s6.txt; run exec_s6.py; fi  # v0.6 OPT-IN S6H sampled fast head (INT4 top-1024 + HX-row refine; high-fidelity, not exact; +0.36 GB)
echo "INSTALL_OK"
